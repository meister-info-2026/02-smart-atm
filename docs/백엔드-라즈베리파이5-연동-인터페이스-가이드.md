...
> **언제 이 문서를 보나요?** `docs/스마트금융보안ATM-실행-가이드.md`의 **4장 라즈베리파이
> ATM 데몬**까지 마치고 나면, 라즈베리파이 5 관련 개발(새 액추에이터 추가, 폴링
...
docs/백엔드-라즈베리파이5-연동-인터페이스-가이드.md의 3장 REST 계약(JSON 스펙 그대로)에 맞춰
...
docs/백엔드-라즈베리파이5-연동-인터페이스-가이드.md의 3장 REST 계약대로 pi/main.py의
...
- `docs/스마트금융보안ATM-실행-가이드.md` 4장 — 라즈베리파이 ATM 데몬 실행 절차
